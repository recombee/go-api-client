...
func TestRecommendItemSegmentsToItem(t *testing.T) {
	...
	resp, err = client.NewRecommendItemSegmentsToItem("entity_id", "entity_id", 5).SetScenario("scenario1").SetCascadeCreate(true).Send()
